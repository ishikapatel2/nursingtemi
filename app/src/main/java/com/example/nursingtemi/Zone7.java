...
public class Zone7 extends AppCompatActivity implements OnRobotReadyListener, OnGoToLocationStatusChangedListener, OnCurrentPositionChangedListener {
        ...
        switch (status) {
            ...
            case "complete":
                if (currentPosition != null) {
                    ...
                    Intent intent = new Intent(Zone7.this, ConfirmMessageActivity.class);
                    ...
                    Log.e("Zone7", "Current position is null");
                }
                updatePosition = true;
                break;
            case "abort":
